...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || eat healthy be healthy</title>
    ...
    <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>apla market happniess at your home </h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>choose your favourite product</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Order vegetable and fruits</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Delivery at your home</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                ...
                <p class="lead">Easiest way to order your favourite and qulity product   </p>
            </div>
            <div class="row">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>shop</h3>
                                <p>fresh fruits and vegetable at your home apli mati aapli mhansa</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose a fruits and vegetable</h3>
                            <p>fresh fruits and vegetable at your home apli mati aapli mhansa</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>Get your vegetable and fruit delivered! And enjoy your product </p>
                        </div>
                    </div>
                </div>
            </div>
