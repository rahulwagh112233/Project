                    ...
                    <div id="main-wrapper">
                        ...
                        <div class="page-wrapper">
                            <div style="padding-top: 10px;">
                                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a href="#">eat healthy be healthy</a> apla market  <a href="#">eat healthy be healthy</a>. For any of your problems contact us on <a href="">Code Camp BD</a> facebook group / page or message <a href="">apla market</a> on facebook. Thanks for staying with <a href="">eat healthy be healthy</a>.</marquee>
                            </div>
                                                    ...
                                                    <div class="row p-t-20">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-danger">
                                                                ...
                                                                <input type="text" name="email" value="<?php echo $row['email'];  ?>" class="form-control form-control-danger" placeholder="apna market05@gmail.com">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row p-t-20">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="phone" class="form-control" value="<?php echo $row['phone'];  ?>" placeholder="+91 9581100981">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-danger">
                                                                ...
                                                                <input type="text" name="url" class="form-control form-control-danger" value="<?php echo $row['url'];  ?>" placeholder="http://apla market.com">
                                                            </div>
                                                        </div>
