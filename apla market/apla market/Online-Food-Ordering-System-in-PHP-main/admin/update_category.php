                    ...
                    <div id="main-wrapper">
                                    ...
                                    <ul id="sidebarnav">
                                        ...
                                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Restaurant</span></a>
                                            <ul aria-expanded="false" class="collapse">
                                                <li><a href="all_restaurant.php">All product</a></li>
                                                <li><a href="add_category.php">Add Category</a></li>
                                                <li><a href="add_restaurant.php">Add product</a></li>
                        ...
                        <div class="page-wrapper">
                            <div style="padding-top: 10px;">
                                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a href="">eat healthy be healthy</a>  <a href="">veat healthy be healthy</a>. For any of your problems contact us on <a href="">eat healthy be healthy</a> facebook group / page or message <a href="">eat healthy be healthy</a> on facebook. Thanks for staying with <a href="">eat healthy be healthy</a>.</marquee>
                            </div>
